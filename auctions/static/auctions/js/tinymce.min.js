...
!function () {
    ...
    var he = function (n) {
        ...
        xe = y(Array.from) ? Array.from : function (e) {
            return be.call(e)
        }, we = Object.keys, Se = Object.hasOwnProperty, Ne = function (e, r) {
            var o = {};
            return ne(e, function (e, t) {
                var n = r(e, t);
                o[n.k] = n.v
    ...
    var Xe = function (e, t) {
        ...
        Ct = -1 !== mt.indexOf("Windows Phone"), xt = {
            ...
            trim: Me, isArray: ke, is: Fe, toArray: function (e) {
                ...
                return n
            }, each: ce, map: le, grep: fe, inArray: de, hasOwn: Ee, extend: function (e) {
    ...
    function tn(e) {
        var r = void 0 === e ? window : e, t = r.document, o = Jt(Et.fromDom(t)), n = void 0 === r ? window : r;
    ...
    var _n = At(1), An = At(3), Rn = At(9), Dn = At(11), Tn = function (e) {
            return A(e.dom.childNodes, Et.fromDom)
        }, On = y(Element.prototype.attachShadow) && y(Node.prototype.getRootNode), Bn = J(On), Pn = On ? function (e) {
            ...
            var n = t.ownerDocument, r = Et.fromDom(t), o = Pn(r);
        ...
        }, Hn = nn(1), jn = on(["textarea", "input"]), Vn = nn(3), qn = nn(8), $n = nn(9), Wn = nn(11), Kn = on(["br"]),
        Xn = on(["img"]), Yn = ln("true"), Gn = ln("false"), Jn = on(["td", "th"]),
        Qn = on(["video", "audio", "object", "embed"]), Zn = function (e, t) {
            return mn(e) ? e.style.getPropertyValue(t) : ""
        }, er = dt().browser, tr = {}, nr = {exports: tr};
    ...
    var ar = nr.exports.boltExport, ur = function (e) {
        function r(e) {
            o() ? i(e) : t.push(e)
        }
        ...
        value: lr, error: fr, fromOption: function (e, t) {
    ...
    function Sr(m, g) {
        function n(e, t, n) {
            var r, o = Nt._addCacheSuffix(e), i = ue(h, o).getOrThunk(function () {
        ...
        void 0 === g && (g = {});
        var p = 0, h = {}, v = Et.fromDom(m), b = Dt(v), y = g.maxLoadTime || 5e3;
        return {
    ...
    var Nr, Er, kr = function (e, t) {
        ...
        }, setTimeout: Cr, setInterval: xr, setEditorTimeout: function (e, t, n) {
            return Cr(function () {
                e.removed || t()
            }, n)
    ...
    function ro(e, n) {
        var r;
        return e && (r = {}, ri(e = "string" == typeof e ? {"*": e} : e, function (e, t) {
    ...
    function oo(i) {
        ...
        var h = ro(i.valid_styles), v = ro(i.invalid_styles, "map"), b = ro(i.valid_classes, "map"),
            ...
            E = "td th iframe video audio object script code", k = e("non_empty_elements", E + " pre", x),
            ...
            if (e) {
                ...
                for (S["@"] && (h = S["@"].attributes, v = S["@"].attributesOrder), t = 0, n = w.length; t < n; t++) if (i = y.exec(w[t])) {
                    if (g = i[1], c = i[2], p = i[3], s = i[5], a = {
                        ...
                        d[t] = e
                    }), m.push.apply(m, v)), s) for (r = 0, o = (s = eo(s, "|")).length; r < o; r++) (i = C.exec(s[r])) && (u = {}, f = i[1], l = i[2].replace(/[\\:]:/g, ":"), g = i[3], b = i[4], "!" === f && (a.attributesRequired = a.attributesRequired || [], a.attributesRequired.push(l), u.required = !0), "-" !== f ? (g && ("=" === g && (a.attributesDefault = a.attributesDefault || [], a.attributesDefault.push({
                        name: l,
                        value: b
        ...
        function L(e) {
            ...
            ei[i.schema] = null, e && ri(eo(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? l[r[2]] : l[r[2]] = {"#comment": {}}, t = l[r[2]], ri(eo(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }
    ...
    var mo = Or(["h1", "h2", "h3", "h4", "h5", "h6"]),
        ...
        ho = Or(["ul", "ol", "dl"]), vo = Or(["li", "dd", "dt"]), bo = Or(["thead", "tbody", "tfoot"]),
        yo = Or(["td", "th"]), Co = Or(["pre", "script", "textarea", "style"]), xo = "\ufeff", wo = "\xa0", So = xo,
        No = function (e) {
            return e === xo
        }, Eo = function (e) {
            return e.replace(/\uFEFF/g, "")
        }, ko = Hn, _o = Vn, Ao = function (e) {
            return _o(e) && e.data[0] === So
        }, Ro = function (e) {
            return _o(e) && e.data[e.data.length - 1] === So
        }, Do = Yn, To = Gn, Oo = Kn, Bo = Vn, Po = on(["script", "style", "textarea"]),
        Lo = on(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]), Io = on(["table"]),
        Mo = Mr, Fo = function (e) {
            return !1 === (Hn(t = e) && "true" === t.getAttribute("unselectable")) && To(e);
            var t
        }, Uo = /^[ \t\r\n]*$/, zo = un("data-mce-bookmark"), Ho = un("data-mce-bogus"), jo = function (e) {
        ...
        Zo = {
            encodeRaw: Jr, encodeAllRaw: function (e) {
                return ("" + e).replace(Ko, function (e) {
                    return Go[e] || e
                })
            }, encodeNumeric: Qr, encodeNamed: Zr, getEncodeFunc: function (e, t) {
                var n = Gr(t) || Qo, r = qo(e.replace(/\+/g, ","));
        ...
        }, ei = {}, ti = {}, ni = Nt.makeMap, ri = Nt.each, oi = Nt.extend, ii = Nt.explode, ai = Nt.inArray, ui = {
            keyLocation: !0,
            layerX: !0,
            layerY: !0,
            returnValue: !0,
            ...
            keyIdentifier: !0,
            mozPressure: !0
        }, si = /^(?:mouse|contextmenu)|click/, ci = (li.prototype.bind = function (e, t, n, r) {
            function o(e) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                for (var m = t.split(" "), g = m.length; g--;) c = o, s = l = !1, "DOMContentLoaded" === (u = m[g]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, fo({type: u})) : (f.hasMouseEnterLeave || (s = f.mouseEnterLeave[u]) && (c = function (e) {
                ...
                }), (a = f.events[i][u]) ? "ready" === u && f.domLoaded ? n(fo({type: u})) : a.push({
                    func: n,
                    scope: r
                }) : (f.events[i][u] = a = [{
                    func: n,
    ...
    var di, mi, gi, pi, hi, vi, bi, yi, Ci, xi, wi, Si, Ni, Ei, ki, _i, Ai, Ri = "sizzle" + -new Date,
        Di = window.document, Ti = 0, Oi = 0, Bi = la(), Pi = la(), Li = la(), Ii = function (e, t) {
            return e === t && (xi = !0), 0
        }, Mi = "undefined", Fi = {}.hasOwnProperty, Ui = [], zi = Ui.pop, Hi = Ui.push, ji = Ui.push, Vi = Ui.slice,
        ...
        Xi = ":(" + Wi + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + Ki + ")*)|.*)\\)|)",
        Yi = new RegExp("^" + $i + "+|((?:^|[^\\\\])(?:\\\\.)*)" + $i + "+$", "g"),
        Gi = new RegExp("^" + $i + "*," + $i + "*"), Ji = new RegExp("^" + $i + "*([>+~]|" + $i + ")" + $i + "*"),
        Qi = new RegExp("=" + $i + "*([^\\]'\"]*?)" + $i + "*\\]", "g"), Zi = new RegExp(Xi),
        ea = new RegExp("^" + Wi + "$"), ta = {
            ID: new RegExp("^#(" + Wi + ")"),
            CLASS: new RegExp("^\\.(" + Wi + ")"),
            TAG: new RegExp("^(" + Wi + "|[*])"),
        ...
        }, na = /^(?:input|select|textarea|button)$/i, ra = /^h\d$/i, oa = /^[^{]+\{\s*\[native \w/,
        ia = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, aa = /[+~]/, ua = /'|\\/g,
    ...
    function va(a, e, t) {
        var u = e.dir, s = t && "parentNode" === u, c = Oi++;
    ...
    function wa(e, t) {
        var n, r = (t = t || Ra).createElement("div"), o = t.createDocumentFragment();
    ...
    di = ca.support = {}, pi = ca.isXML = function (e) {
        ...
        var t, s = e ? e.ownerDocument || e : Di, n = s.defaultView;
                ...
                return 1 === g && 0 === p ? function (e) {
                    ...
                    if (l) {
                        ...
                        if (s = [v ? l.firstChild : l.lastChild], v && d) {
                            for (u = (r = (o = l[Ri] || (l[Ri] = {}))[m] || [])[0] === Ti && r[1], a = r[0] === Ti && r[2], i = u && l.childNodes[u]; i = ++u && i && i[c] || (a = u = 0) || s.pop();) if (1 === i.nodeType && ++a && i === e) {
                                o[m] = [Ti, u, a];
                                break
                            }
                        } else if (d && (r = (e[Ri] || (e[Ri] = {}))[m]) && r[0] === Ti) a = r[1]; else for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Ri] || (i[Ri] = {}))[m] = [Ti, a]), i !== e));) ;
        ...
        pseudos: {
            not: fa(function (e) {
                ...
                return t = t.replace(sa, fi), function (e) {
                    return -1 < (e.textContent || e.innerText || gi(e)).indexOf(t)
                }
            }), lang: fa(function (n) {
                return ea.test(n || "") || ca.error("unsupported lang: " + n), n = n.replace(sa, fi).toLowerCase(), function (e) {
                    var t;
                    do {
        ...
        if (!i) {
            for (n = (t = t || hi(e)).length; n--;) ((i = function e(t) {
                for (var o, n, r, i = t.length, a = mi.relative[t[0].type], u = a || mi.relative[" "], s = a ? 1 : 0, c = va(function (e) {
                    ...
                    return o = null, r
                }]; s < i; s++) if (n = mi.relative[t[s].type]) f = [va(ba(f), n)]; else {
                        ...
                        return function e(m, g, p, h, v, t) {
                            return h && !h[Ri] && (h = e(h)), v && !v[Ri] && (v = e(v, t)), fa(function (e, t, n, r) {
                                var o, i, a, u = [], s = [], c = t.length, l = e || function (e, t, n) {
                                        ...
                                        return n
                                    }(g || "*", n.nodeType ? [n] : n, []), f = !m || !e && g ? l : ya(l, u, m, n, r),
                                    d = p ? v || (e ? m : c || h) ? [] : t : f;
        ...
        function a(e, t, n, r, o) {
            var i, a, u, s = 0, c = "0", l = e && [], f = [], d = yi, m = e || y && mi.find.TAG("*", o),
                g = Ti += null == d ? 1 : Math.random() || .1, p = m.length;
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && hi(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
            ...
            for (o = ta.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !mi.relative[u = a.type]);) if ((s = mi.find[u]) && (r = s(a.matches[0].replace(sa, fi), aa.test(i[0].type) && ga(t.parentNode) || t))) {
    ...
    var Ra = document, Da = Array.prototype.push, Ta = Array.prototype.slice,
        Oa = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, Ba = ci.Event, Pa = Nt.makeMap("children,contents,next,prev"),
        La = function (e, t, n, r) {
            var o;
            if (xa(t)) t = wa(t, Va(e[0])); else if (t.length && !t.nodeType) {
                if (t = Ya.makeArray(t), r) for (o = t.length - 1; 0 <= o; o--) La(e, t[o], n, r); else for (o = 0; o < t.length; o++) La(e, t[o], n, r);
                return e
            }
        ...
        Fa = {for: "htmlFor", class: "className", readonly: "readOnly"}, Ua = {float: "cssFloat"}, za = {}, Ha = {},
        ja = /^\s*|\s*$/g, Va = function (e) {
    ...
    function $a(e, t, n, r) {
        var o = [];
        for (r instanceof Ya && (r = r[0]); e; e = e[t]) if (!n || e.nodeType === n) {
            if (void 0 !== r) {
                if (e === r) break;
    ...
    Ea.fn = Ea.prototype = {
        constructor: Ea, selector: "", context: null, length: 0, init: function (e, t) {
            ...
            if (xa(e)) {
                ...
                if (n[1]) for (r = wa(e, Va(t)).firstChild; r;) Da.call(o, r), r = r.nextSibling; else {
            ...
            if (!1 !== t) for (n = Ya.unique(this.toArray().concat(Ya.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r]; else Da.apply(this, Ya.makeArray(e));
            return this
        }, attr: function (t, n) {
            var e, r = this;
            ...
            if ("object" == typeof t) _a(t, function (e, t) {
                ...
                var e = this.style;
                if ((i = Ha[t]) && i.set) i.set(this, n); else {
                    try {
                        this.style[Ua[t] || t] = n
                    } catch (e) {
                    }
        ...
        }, push: Da, sort: Array.prototype.sort, splice: Array.prototype.splice
    }, Nt.extend(Ea, {
        extend: Nt.extend,
    ...
    var Ya = Ea, Ga = Nt.each, Ja = Nt.grep, Qa = xt.ie, Za = /^([a-z0-9],?)+$/i, eu = function (a, u) {
        function s(e) {
        ...
        var _, A, R, D, e, t, T = {}, O = window, B = {}, P = 0,
            ...
            U = u.ownEvents ? new ci : ci.Event, z = M.getBlockElements(), H = Ya.overrideDefaults(function () {
                return {context: a, element: $.getRoot()}
            }), j = Zo.encodeAllRaw, V = function (e, t, n, r) {
                if (Nt.isArray(e)) {
                ...
                isEmpty: function (e, t) {
                    ...
                    if (N(e)) return !1;
                    if (e = e.firstChild) {
                        var i = new Dr(e, e.parentNode), a = M ? M.getWhiteSpaceElements() : {};
    ...
    var tu = eu.DOM, nu = Nt.each, ru = Nt.grep, ou = (iu.prototype._setReferrerPolicy = function (e) {
        ...
        var o = tu, i = o.uniqueId(), a = document.createElement("script");
    ...
    var su = {}, cu = au("en"), lu = {
        getData: function () {
            ...
            var o, i, a = uu().getOr({}), u = function (e) {
                return "" === e || null == e
            };
            if (u(e)) return "";
    ...
    function Su(e, t) {
        var n, r, o = Rt(e).dom, i = Et.fromDom(o.createDocumentFragment());
    ...
    var qu = function (e, t) {
        ...
        }, $u = J("mce-annotation"), Wu = J("data-mce-annotation"), Ku = J("data-mce-annotation-uid"),
        Xu = function (e, t) {
        ...
        Qu = Hn, Zu = Vr, es = an("display", "block table"), ts = an("float", "left right"), ns = function () {
            for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
            return function (e) {
                for (var t = 0; t < n.length; t++) if (!n[t](e)) return !1;
                return !0
            }
        }(Qu, Zu, s(ts)), rs = s(an("white-space", "pre pre-line pre-wrap")), os = Vn, is = Kn, as = eu.nodeIndex,
        us = function (e, t) {
            if (!(t < 0 && Hn(e) && e.hasChildNodes())) return Iu(e, t)
        }, ss = function (e) {
            var t = e.getClientRects(), n = 0 < t.length ? Ru(t[0]) : Ru(e.getBoundingClientRect());
            return !zu(e) && is(e) && ju(n) ? function (e) {
                var t = e.ownerDocument, n = Fu(t), r = t.createTextNode(wo), o = e.parentNode;
    ...
    function Ws(e, i, a, u) {
        ...
        var c, l, f = du(), t = ks(e), d = 0 < t.length ? t : "p";
        return {
            show: function (e, t) {
                var n;
                if (s(), Nc(t)) return null;
                if (!a(t)) return l = function (e, t) {
                    var n = e.ownerDocument.createTextNode(So), r = e.parentNode;
                    if (t) {
    ...
    function nc(e, t, n) {
        var r, o = R(tc, !0, t), i = R(tc, !1, t), a = n.startContainer, u = n.startOffset;
        if (Lr(a)) {
    ...
    var sc, cc, lc = Vn, fc = sn, dc = eu.nodeIndex, mc = function (e) {
            var t = e.parentNode;
            return fc(t) ? mc(t) : t
        }, gc = function (e) {
        ...
        }, pc = Gn, hc = R(xs, u, !0), vc = eu.DOM, bc = Hn, yc = Vn, Cc = function (e) {
            bc(e) && Mr(e) && (Fr(e) ? e.removeAttribute("data-mce-caret") : Us(e)), yc(e) && (Hs(e), 0 === e.data.length && Us(e))
        }, xc = dt().browser, wc = Gn, Sc = Qn, Nc = Jn, Ec = function (e) {
            return wc(e) || Sc(e)
        }, kc = Gn, _c = Qn, Ac = an("display", "block table table-cell table-caption list-item"), Rc = Mr, Dc = Lr,
        Tc = Hn, Oc = Vr, Bc = R(ec, !0), Pc = R(ec, !1);
    ...
    function xl(i, e, t, n, a, r) {
        function o(e, t, n) {
            var r = Au(i), o = a ? r.backwards : r.forwards;
    ...
    function wl(e, t, n, r, o) {
        ...
        for (var i = ff(e, r), a = 0; a < i.length; a++) for (var u = 0; u < t.length; u++) {
            var s = t[u];
    ...
    function Sl(t, e, n, r) {
        ...
        if ((i = ml(s) ? s.wrapper ? null : a.getParent(n, s.block, u) : i) || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(Vn(n) ? n.parentNode : n, function (e) {
            return e !== u && mf(t, e)
        }, o)), !(i = i && ml(s) && s.wrapper && ff(a, i, "ul,ol").reverse()[0] || i)) for (i = n; i[r] && !a.isBlock(i[r]) && !ul(i = i[r], "br");) ;
        return i || n
    }
    ...
    function _l(n, e, u) {
        ...
        var o = e.startOffset, i = Iu(e.startContainer, o), a = e.endOffset, l = Iu(e.endContainer, a - 1);
        if (i === l) return u(s([i]));
    ...
    function Ol(o, e) {
        return dn((r = e.startContainer, i = e.startOffset, Vn(r) ? 0 === i ? ve.some(Et.fromDom(r)) : ve.none() : ve.from(r.childNodes[i]).map(Et.fromDom)), (t = e.endContainer, n = e.endOffset, Vn(t) ? n === t.data.length ? ve.some(Et.fromDom(t)) : ve.none() : ve.from(t.childNodes[n - 1]).map(Et.fromDom)), function (e, t) {
            var n = M(pf(o), R(je, e)), r = M(hf(o), R(je, t));
    ...
    function Bl(e, t, n, r) {
        var o = n, i = new Dr(n, o), a = ae(e.schema.getMoveCaretBeforeOnEnterElements(), function (e, t) {
    ...
    function Fl(e, t, n, r) {
        var o = t.uid, i = void 0 === o ? wu("mce-annotation") : o, a = function (e, t) {
            var n = {};
    ...
    function Ul(u, e, t, n, r) {
        ...
        var l = [], f = Fl(u.getDoc(), r, t, n), d = du(), o = function (e) {
            var t, n, r, o, i, a;
            ...
            register: function (e, t) {
                ...
                i.lookup(t).each(function (e) {
                    ...
                    s = t, c = e, l = n, (u = o).undoManager.transact(function () {
                        var e, t, n, r, o = u.selection, i = o.getRng(), a = 0 < Dl(u).length;
                        i.collapsed && !a && (n = kl(e = u, t = i, [{inline: "span"}]), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)), o.getRng().collapsed && !a ? (Su(r = Fl(u.getDoc(), l, s, c.decorate), wo), o.getRng().insertNode(r.dom), o.select(r.dom)) : Il(o, !1, function () {
                            Ll(u, function (e) {
    ...
    var Vl, ql, $l, Wl = Gn, Kl = Vn, Xl = Hn, Yl = Kn, Gl = Vr, Jl = qr, Ql = function (e, t, n) {
        var r, o, i;
        ...
        var f = Gs(r, e, Jl, n), d = pe(U(function (e, t) {
    ...
    function Sf(r, l) {
        ...
        var p, h, v, b, y, C, x, w, S, N, E, k, _, A, R, D = "data-mce-selected", T = l.dom, O = Nt.each,
    ...
    var Ff, Uf, zf = (Ff = "height", Uf = function (e) {
        ...
        }, get: Hf, getOuter: Hf, aggregate: jf, max: function (e, t, n) {
            var r = jf(e, n);
            return r < t ? t - r : 0
        }
    });
    ...
    function jf(o, e) {
        return L(e, function (e, t) {
            var n = wn(o, t), r = void 0 === n ? 0 : parseInt(n, 10);
    ...
    function Jf(e, t, n, r) {
        Yf(e, t, e.dom.defaultView.innerHeight, n, r);
        var o, i, a, u, s, c, l,
            f = (o = n.element, u = Jt(Et.fromDom(document)), a = (i = Dd).owner(o), s = Rd(i, a), c = zn(o), l = P(s, function (e, t) {
                var n = zn(t);
                return {left: e.left + n.left, top: e.top + n.top}
            }, {left: 0, top: 0}), Un(l.left + c.left + u.left, l.top + c.top + u.top)), d = tn(window);
    ...
    var Ad, Rd = function (r, e) {
            ...
            var a, u, s, c, l = (a = Et.fromDom(n.startContainer), u = n.startOffset, s = function (e, t) {
                ...
                var r = n[n.length - 1];
                return Vf(r) ? {element: e, offset: t} : "img" === kt(r) ? {element: r, offset: 1} : An(r) ? {
                    element: r,
                    offset: Ml(r).length
        ...
        Id = {
            domRange: Ld.domRange, relative: Ld.relative, exact: Ld.exact, exactFromRange: function (e) {
    ...
    function em(r, e) {
        var t = [{condition: R(Jd, e), action: R(Qd, e)}, {condition: Yd, action: im}, {condition: Gd, action: am}],
            o = r, i = !1;
        return Y(t, function (e) {
            var t = e.condition, n = e.action;
    ...
    function nm(e) {
        var u = [], s = (e = e || {}).indent, c = sm(e.indent_before || ""), l = sm(e.indent_after || ""),
            f = Zo.getEncodeFunc(e.entity_encoding || "raw", e.entities), d = "html" === e.element_format;
        return {
    ...
    var om = Nt.makeMap("NOSCRIPT STYLE SCRIPT XMP IFRAME NOEMBED NOFRAMES PLAINTEXT", " "), im = i(Zd, Kd),
        am = i(Zd, Xd), um = Nt.each, sm = Nt.makeMap, cm = new Set;
    ...
    function Fm(g, e) {
        return ve.some(e).filter(Mm).bind(function (e) {
            var t, n, r, o, i, a, u, s, c, l = e.container(), f = g, d = (i = l).data, m = cs(i, 0);
    ...
    function dg(e) {
        var t = Dl(e), n = Et.fromDom(e.selection.getNode());
    ...
    function gg(e, t, n, r) {
        ...
        var u = Kr(i) ? t : t.slice(1), s = Kr(a) ? n : n.slice(0, -1);
    ...
    function yg(e, t) {
        var n, r, o, i, a, u, s, c, l = Et.fromDom(e.selection.getStart(!0)), f = Dl(e);
    ...
    function Ng(e, t) {
        var n = cs.after(e), r = Mc(t).prev(n);
        return r ? r.toRange() : null
    }

    function Eg(e, o, i, t) {
        function n(e) {
            var t = cs.fromRangeStart(i), n = Mc(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
            return !r || Sg(o, r.getNode()) !== R
        }

        var r, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w, S, N, E, k, _,
    ...
    function kg(e, t, n) {
        ...
        var c = e.parser, l = n.merge, f = rm({validate: e.getParam("validate")}, e.schema),
        ...
        if (m.isDefaultPrevented()) e.fire("SetContent", {
            ...
            var b, y, C, x, w, S, N, E, k, _, A, R, D, T,
    ...
    function Ag(e, t, n) {
        ...
        e.dom.setHTML(e.getBody(), t), !0 !== n && Cd(r = e) && rf(r.getBody()).each(function (e) {
            var t = e.getNode(), n = cn(t) ? rf(t).getOr(e) : e;
    ...
    function Rg(u, s, e) {
        ...
        return _g(s) || (s = c.content), ve.from(u.getBody()).fold(J(s), function (e) {
            ...
            }(u, e, s, c) : (t = u, n = e, o = c, 0 === (r = Eo(r = s)).length || /^\s+$/.test(r) ? (i = '<br data-mce-bogus="1">', "TABLE" === n.nodeName ? r = "<tr><td>" + i + "</td></tr>" : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + i + "</li>"), r = (a = ks(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), a.toLowerCase()) ? (r = i, t.dom.createHTML(a, _s(t), r)) : r || '<br data-mce-bogus="1">', Ag(t, r, o.no_selection), t.fire("SetContent", o)) : ("raw" !== o.format && (r = rm({validate: t.validate}, t.schema).serialize(t.parser.parse(r, {
                isRootContent: !0,
                insert: !0
    ...
    function Lg(e, t, n, r, o, i) {
        ...
        if (a) if (b(a.length)) {
            for (var u in a) if (Ee(a, u)) {
                var s = "attributes" === r ? e.getAttrib(t, u) : cl(e, t, u), c = al(a[u], i), l = K(s) || Pe(s);
                if (!l || !K(c)) {
    ...
    function Hg(e, t, n) {
        ...
        if (t) zg(e, t, n); else if (!(t = qc(e.getBody(), o.getStart()))) for (; t = r.get(xp);) zg(e, t, !1)
    }
    ...
    function $g(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y = e.dom, C = e.selection, x = [], w = C.getRng(),
            S = w.startContainer, N = w.startOffset, E = S;
    ...
    var Kg, Xg = ["font", "text-decoration", "text-emphasis"], Yg = R(fm, !0, Zc), Gg = R(fm, !1, Zc), Jg = mm(!0, gm),
        Qg = mm(!1, gm), Zg = mm(!0, Qn), ep = mm(!1, Qn), tp = mm(!0, cn), np = mm(!1, cn), rp = mm(!0, pm),
        op = mm(!1, pm), ip = R(Sm, !1), ap = R(Sm, !0), up = R(wm, !1), sp = R(wm, !0), cp = R(Em, !1), lp = R(Em, !0),
        ...
        dp = function (e) {
            ...
            var o, i = dp(n).getOr(n), a = Et.fromDom(e.dom.getParent(i.dom, e.dom.isBlock));
        ...
        }, Cp = So, xp = "_mce_caret", wp = {}, Sp = fe, Np = ce;
    ...
    function Mp(e, r, o, t, i) {
        ...
        if ("all" !== r.remove) {
            Ah(r.styles, function (e, t) {
                ...
                var n;
                if (e = al(e, o), N(t) && (t = e, i = null), r.remove_similar || !i || Rh(u.getAttrib(i, t), e)) if ("class" === t && (e = u.getAttrib(b, t)) && (n = "", Y(e.split(/\s+/), function (e) {
                    /mce\-\w+/.test(e) && (n += (n ? " " : "") + e)
    ...
    function Up(u, s, c, e, l) {
        ...
        if ("false" !== h.getContentEditable(r.getNode())) r.isCollapsed() && pl(g) && !Dl(u).length ? $g(u, s, c, l) : (Il(r, !0, function () {
            Ll(u, t)
        }), pl(g) && Ig(u, s, c, r.getStart()) && nl(h, r, r.getRng()), u.nodeChanged()), wf(u, s, e, c); else {
            e = r.getNode();
    ...
    function Zp(e, t) {
        var n, r, o, i = Et.fromDom(t.commonAncestorContainer), a = ym(i, e), u = U(a, function (e) {
            return Br(e) || mo(e)
    ...
    function uh(e) {
        var t = e.serializer.getTempAttrs(), n = em(e.getBody(), t);
            ...
            undoManager: {
                ...
                match: function (e, t, n, r) {
                    ...
                    return function (e) {
                        ...
                        if (t) for (var r = fl(n, e.selection.getStart()), o = t.length - 1; 0 <= o; o--) {
                            var i = t[o];
                ...
                getContent: function (e, t) {
                    return function (e, t, n) {
                        ...
                        i.getInner = !0;
                        var a, u, s, c, l, f, d, m,
                            g = (u = i, s = (a = e).selection.getRng(), c = a.dom.create("body"), l = a.selection.getSel(), f = Ed(a, Al(l)), (d = u.contextual ? nh(Et.fromDom(a.getBody()), f).dom : s.cloneContents()) && c.appendChild(d), a.selection.serializer.serialize(c, u));
    ...
    function wh(e, t, n) {
        ...
        !function (e, t) {
            var n = ve.from(t.firstChild).map(Et.fromDom), r = ve.from(t.lastChild).map(Et.fromDom);
            e.deleteContents(), e.insertNode(t);
            var o = n.bind(Bt).filter(An).bind(Ch), i = r.bind(Pt).filter(An).bind(Ch);
    ...
    var Nh = Nt.each, Eh = function (e, t, n) {
            Nh(e.childNodes, function (e) {
                Ep(e) && (t(e) && n(e), e.hasChildNodes() && Eh(e, t, n))
            })
        }, kh = ir([{keep: []}, {rename: ["name"]}, {removed: []}]), _h = /^(src|href|style)$/, Ah = Nt.each, Rh = ul,
        Dh = Nt.each, Th = Nt.each, Oh = function (S, N, E, r) {
            function k(n, e) {
                var t;
                    ...
                    var s, c = function (e) {
                        ...
                        if (Hn(e) && x.getContentEditable(e) && (n = f, f = "true" === x.getContentEditable(e), t = !0), Kn(e) && !function (e, t, n, r) {
                            if (e.getParam("format_empty_lines", !1, "boolean") && pl(t)) {
                                var o = no(e.schema), i = (a = Et.fromDom(n), s = function (e) {
                                    return Vc(e.dom)
                        ...
                        if (ml(A) && A.wrapper && yp(S, e, N, E)) s = null; else {
            ...
            var e, t, n, i, _ = S.formatter.get(N), A = _[0], a = !r && S.selection.isCollapsed(), u = S.dom,
                s = S.selection;
        ...
        var l, f, o, i, d, m, g = function (e, t) {
            ...
            getSelectedBlocks: function (e, t) {
                return function (e, t, n, r) {
                    var o = [], i = e.getRoot();
                    if (n = e.getParent(n || wd(i, t, t.collapsed), e.isBlock), r = e.getParent(r || Sd(i, t, t.collapsed), e.isBlock), n && n !== i && o.push(n), n && r && n !== r) for (var a, u = new Dr(n, i); (a = u.next()) && a !== r;) e.isBlock(a) && o.push(a);
    ...
    function Xh(e, p) {
        ...
        p.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
            var r, o, i, a, u, s, c, l, f = e.length, d = Nt.extend({}, h.getBlockElements()),
    ...
    function iv(q, $) {
        void 0 === $ && ($ = oo()), q = q || {};
        var W = uv(), K = W.createElement("form");
        ...
        function n(s, e) {
            ...
            for (var t, i, n, c, r, o, a, l, u, f, d, m, g, p, h, v, b, y, C, x = s.html, w = 0, S = [], N = 0, E = Zo.decode, k = Nt.makeMap("src,href,data,background,action,formaction,poster,xlink:href"), _ = "html" === e ? 0 : 1, A = function (e) {
                ...
                var j = t[0];
                if (w < t.index && R(E(x.substr(w, t.index - w))), i = t[7]) A(i = ":" === (i = i.toLowerCase()).charAt(0) ? i.substr(1) : i); else if (i = t[8]) {
                    ...
                    if (!M || (f = $.getElementRule(i))) {
                        if (d = !0, M && (p = f.attributes, h = f.attributePatterns), (g = t[9]) ? ((l = -1 !== g.indexOf("data-mce-type")) && F && (d = !1), (c = []).map = {}, g.replace(B, function (e, t, n, r, o) {
                            ...
                            if (v = f.attributesRequired, b = f.attributesDefault, y = f.attributesForced, f.removeEmptyAttrs && !c.length && (d = !1), y) for (r = y.length; r--;) a = (m = y[r]).name, "{$uid}" === (C = m.value) && (C = "mce_" + N++), c.map[a] = C, c.push({
                                name: a,
                                value: C
                            });
                            if (b) for (r = b.length; r--;) (a = (m = b[r]).name) in c.map || ("{$uid}" === (C = m.value) && (C = "mce_" + N++), c.map[a] = C, c.push({
                                name: a,
                                value: C
                            }));
                            if (v) {
    ...
    function cv(A, R) {
        ...
        var e = {
            schema: R, addAttributeFilter: function (e, n) {
                ...
                var g = Tv(Av("script,style,head,html,body,title,meta,param"), R.getBlockElements()), p = no(R),
                    ...
                    N = /^[ \t\r\n]+$/, E = Ee(C, s.context) || Ee(C, A.root_name), k = iv({
                        validate: b,
                        document: A.document,
                        ...
                        start: function (e, t, n) {
                            ...
                            if (i) {
                                if (g[e] && !E) {
                                    if ((t = l.firstChild) && 3 === t.type) if (0 < (n = t.value.replace(x, "")).length) t.value = n, t = t.next; else for (r = t.next, t.remove(), t = r; t && 3 === t.type;) n = t.value, r = t.next, 0 !== n.length && !N.test(n) || (t.remove(), t = r), t = r;
                                    if ((t = l.lastChild) && 3 === t.type) if (0 < (n = t.value.replace(w, "")).length) t.value = n, t = t.prev; else for (r = t.prev, t.remove(), t = r; t && 3 === t.type;) n = t.value, r = t.prev, 0 !== n.length && !N.test(n) || (t.remove(), t = r), t = r
                                }
                                E && C[e] && (E = !1);
                                var a = Kh(R, h, C, l), u = l.parent;
                    ...
                    }, R), _ = l = new jd(s.context || A.root_name, 11);
                if (k.parse(e, s.format), b && f.length && (s.context ? s.invalid = !0 : function (e) {
                    for (var t = Av("tr,td,th,tbody,thead,tfoot,table"), n = R.getNonEmptyElements(), r = R.getWhiteSpaceElements(), o = R.getTextBlockElements(), i = R.getSpecialElements(), a = function (e, t) {
                        ...
                        if (c.parent && !c.fixed) if (o[c.name] && "li" === c.parent.name) {
                            ...
                            } else a(c); else c.parent && ("li" !== c.name ? R.isValidChild(c.parent.name, "div") && R.isValidChild("div", c.name) ? c.wrap(P(new jd("div", 1))) : a(c) : !(d = c.prev) || "ul" !== d.name && "ol" !== d.name ? !(d = c.next) || "ul" !== d.name && "ol" !== d.name ? c.wrap(P(new jd("ul", 1))) : d.insert(c, d.firstChild, !0) : d.append(c))
                        }
                    }
    ...
    function fv(L, I) {
        ...
        return (t = U).addAttributeFilter("data-mce-tabindex", function (e, t) {
            ...
            serialize: function (e, t) {
                var n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w, S, N, E, k, _, A, R, D,
                    ...
                    }), w = "BODY" !== w.nodeName ? b.body.firstChild : b.body, v = x.doc, x.doc = b), y = p, C = _e(_e({}, h), {node: w}), y.fire("PreProcess", C), v && (x.doc = v), w) : m), o = Eo((r = T).getInner ? n.innerHTML : M.getOuterHTML(n)), r.selection || Co(Et.fromDom(n)) ? o : Nt.trim(o)),
    ...
    function yv(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d = hv(n.forced_plugins), m = hv(r.plugins),
            g = vv(o = t, "mobile") ? o.sections().mobile : {}, p = g.plugins ? hv(g.plugins) : m,
    ...
    function Nv(e, t, n) {
        var r, o, i, a, u, s, c = Et.fromDom(e.getBody()), l = e.inline ? c : Et.fromDom(Dt(c).dom.documentElement),
    ...
    function Ev(o) {
        ...
        function t(n, e) {
            if (void 0 === e && (e = !0), !o.removed && (r = (t = o).inline ? t.getBody() : t.getContentAreaContainer(), ve.from(r).map(Et.fromDom).map(Mn).getOr(!1))) return e && o.fire("BeforeOpenNotification", {notification: n}), M(c, function (e) {
    ...
    iv.findEndTag = ov;
    var kv, _v, Av = Nt.makeMap, Rv = Nt.each, Dv = Nt.explode, Tv = Nt.extend, Ov = eu.DOM,
        Bv = (kv = function (e, t) {
        ...
        Iv = "imagetools,toc".split(","), Mv = dt().deviceType, Fv = Mv.isTouch(), Uv = Mv.isPhone(),
        zv = Mv.isTablet(), Hv = ["lists", "autolink", "autosave"],
        jv = {table_grid: !1, object_resizing: !1, resize: !1}, Vv = (_v = {}, {
            add: function (e, t) {
                _v[e] = t
            }, get: function (e) {
                return _v[e] || {icons: {}}
        ...
        }), qv = R(wv, "clientWidth"), $v = R(wv, "clientHeight"), Wv = R(Sv, "margin-top"), Kv = R(Sv, "margin-left"),
        Xv = fu.PluginManager, Yv = fu.ThemeManager;
    ...
    function ib() {
        ...
        function i(e) {
            ...
            var t = e.id || ob("blobid"), n = e.name || t, r = e.blob;
            return {
                id: J(t),
                name: J(n),
    ...
    function cb(l) {
        ...
        var u, s, c, d, m = ib(), g = rb(), p = [], h = (d = au(null), (c = l).on("change AddUndo", function (e) {
            d.set(_e({}, e.level))
        }), {
    ...
    function db(n, e) {
        ...
        var s, c = e.block || e.inline || "span",
            l = (s = e.selector) && "string" == typeof s ? (s = (s = s.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Nt.map(s.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                var t = Nt.map(e.split(/(?:~\+|~|\+)/), fb), n = t.pop();
                return t.length && (n.siblings = t), n
            }).reverse()) : [], f = l.length ? (l[0].name || (l[0].name = c), c = e.selector, lb(l, n)) : lb([c], n),
    ...
    function pb(s) {
        var e, n, r, o, i, c = du(), l = au(0), f = au(0), d = {
    ...
    function Ub(e, t, n) {
        var r = nc(1, e.getBody(), t), o = cs.fromRangeStart(r), i = o.getNode();
    ...
    function qb(e, t) {
        ...
        var r = t ? sc.Forwards : sc.Backwards, o = Mc(e.getBody()), i = R(ac, t ? o.next : o.prev), a = t ? Hb : jb,
            u = oc(r, e.getBody(), n), s = Cb(t, i(u));
    ...
    function Yb(e) {
        var t, n = e.dom, r = e.selection, o = bf(e.getBody(), r.getNode());
    ...
    var Sy, Ny, Ey = function (t, e) {
        ...
        Dy = "data-mce-placeholder", Ty = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/, Oy = R(Cb, !0), By = R(Cb, !1),
        Py = Yn, Ly = Gn,
        Iy = ir([{remove: ["element"]}, {moveToElement: ["element"]}, {moveToPosition: ["position"]}]), My = Vn,
        Fy = R(ty, !0), Uy = R(ty, !1),
    ...
    var Gy, Jy, Qy = R(qy, cs.isAbove, -1), Zy = R(qy, cs.isBelow, 1), e0 = R($y, -1, Qy), t0 = R($y, 1, Zy);
    ...
    function c0(e, o, i) {
        return void 0 === i && (i = w), me(e, function (e, t) {
            ...
            var n = Math.min(i0(e, o), a0(e, o)), r = Math.min(i0(t, o), a0(t, o));
    ...
    function f0(e, t, n) {
        ...
        var o, i, a, u = Yy(U(xe(e.getElementsByTagName("*")), Xs)), s = U(u, R(s0, n));
        ...
        }(e, a, r(a)), t, r)) && Xs(a.node))) return {node: (o = a).node, before: i0(o, i = t) < a0(o, i)};
        return null
    }
    ...
    function g0(e, t, n, r, o, i) {
        var a = t === sc.Forwards, u = Mc(e.getBody()), s = R(ac, a ? u.next : u.prev), c = a ? r : o;
        if (!n.collapsed) {
            var l = Lu(n);
    ...
    function p0(t, e, n, r, o, i) {
        var a = oc(e, t.getBody(), n), u = pe(a.getClientRects()), s = e === Gy.Down;
        if (!u) return ve.none();
        var c, l = U((s ? QC : JC)(t.getBody(), r0(1), a), o0(1)), f = u.left, d = c0(l, f);
        if (d && i(d.node)) {
        ...
        if (c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Lu(n)) {
            var p = function (e, t, n, r) {
                ...
                return c
            }(e, t.getBody(), r0(1), c), h = c0(U(p, o0(1)), f);
    ...
    function A0(g, p) {
        ...
        return Z(h).exists(function (e) {
            var t, n, r, o, i, a, u, s, c, l = cs.fromRangeStart(g.selection.getRng()), f = p, d = l, m = e.dom;
            return !(!dn(rf(m), of(m), function (e, t) {
                var n = Cb(!0, e), r = Cb(!1, t), o = Cb(!1, d);
    ...
    function I0(e, s) {
        var c = e.dom, t = e.selection, n = e.formatter, r = e.getParam("indentation", "40px", "string"),
            l = /[a-z%]+$/i.exec(r)[0], f = parseInt(r, 10), d = Os(e), o = ks(e);
    ...
    function M0(e, t) {
        if (e.selection.isCollapsed() && P0(e)) {
            var n = e.dom, r = e.selection.getRng(), o = cs.fromRangeStart(r),
    ...
    function q0(e, t, n) {
        var r, o, i, a = Mc(e.getBody()), u = R(ac, 1 === t ? a.next : a.prev);
    ...
    function J0(h, v) {
        var b = Et.fromDom(h.getBody()), y = cs.fromRangeStart(h.selection.getRng()), C = ks(h), x = _s(h), e = y,
            t = R(je, b);
    ...
    function tC(t, e) {
        var n = e ? sc.Forwards : sc.Backwards, r = t.selection.getRng();
    ...
    function sC(e, t, n, r) {
        var o, i, a, u, s, c, l, f, d, m, g = e.selection.getRng(), p = cs.fromRangeStart(g), h = e.getBody();
    ...
    function SC(e, t) {
        ...
        n && n.toLowerCase() === t.tagName.toLowerCase() && function (e, o, t) {
            ...
            ve.from(t.style).map(i.parseStyle).each(function (e) {
                var t = Nn(Et.fromDom(o)), n = _e(_e({}, t), e);
                i.setStyles(o, n)
    ...
    function NC(a, e) {
        function t(e) {
            ...
            if (!1 === a.getParam("keep_styles", !0)) c.setAttrib(o, "style", null), c.setAttrib(o, "class", null); else for (; r[n.nodeName] && (Vc(n) || Qc(n) || (t = n.cloneNode(!1), c.setAttrib(t, "id", ""), o.hasChildNodes() ? t.appendChild(o.firstChild) : i = t, o.appendChild(t))), (n = n.parentNode) && n !== F;) ;
        ...
        F && ((p && !h || !p && h) && (m = function (e, t, n, r) {
            var o, i, a, u, s, c, l = p || "P", f = e.dom, d = wC(f, n), m = f.getParent(n, f.isBlock);
            if (!m || !CC(f, m)) {
        ...
        }(c, b), c.isEmpty(b) && bC(b), u.normalize(), c.isEmpty(u) ? (c.remove(u), r()) : (SC(a, u), dC(a, u))), c.setAttrib(u, "id", ""), a.fire("NewBlock", {newBlock: u})))
    }
    ...
    function YC(e) {
        var t, n, r = cs.fromRangeStart(e.selection.getRng()), o = Et.fromDom(e.getBody());
        if (e.selection.isCollapsed()) {
            var i = R(bb, e), a = cs.fromRangeStart(e.selection.getRng());
    ...
    function GC(e) {
        ...
        return e.on("keyup compositionstart", R(V0, e)), g = p, (m = e).on("keydown", function (e) {
            ...
            !1 === e.isDefaultPrevented() && (t = m, n = g, r = e, o = dt().os, eC([{
                keyCode: If.RIGHT,
                action: Z0($0, t, !0)
            }, {keyCode: If.LEFT, action: Z0($0, t, !1)}, {keyCode: If.UP, action: Z0(W0, t, !1)}, {
                keyCode: If.DOWN,
                action: Z0(W0, t, !0)
            }, {keyCode: If.RIGHT, action: Z0(lC, t, !0)}, {keyCode: If.LEFT, action: Z0(lC, t, !1)}, {
                keyCode: If.UP,
                action: Z0(fC, t, !1)
            }, {keyCode: If.DOWN, action: Z0(fC, t, !0)}, {keyCode: If.RIGHT, action: Z0(tC, t, !0)}, {
                keyCode: If.LEFT,
                action: Z0(tC, t, !1)
            }, {keyCode: If.UP, action: Z0(nC, t, !1)}, {keyCode: If.DOWN, action: Z0(nC, t, !0)}, {
                keyCode: If.RIGHT,
                action: Z0(C0, t, n, !0)
                ...
                keyCode: If.UP,
                action: Z0(Q0, t, !1)
            }, {keyCode: If.DOWN, action: Z0(Q0, t, !0)}], r).each(function (e) {
                r.preventDefault()
            }))
            ...
            !1 === e.isDefaultPrevented() && (n = e, eC([{
                keyCode: If.BACKSPACE,
                action: Z0(Yb, t = f)
            }, {keyCode: If.DELETE, action: Z0(Yb, t)}], n))
            ...
            !1 === e.isDefaultPrevented() && (n = s, r = e, eC([{
                keyCode: If.END,
                action: Z0(K0, t = u, !0)
            }, {keyCode: If.HOME, action: Z0(K0, t, !1)}, {keyCode: If.END, action: Z0(rC, t, !0)}, {
                keyCode: If.HOME,
                action: Z0(rC, t, !1)
    ...
    var JC = R(n0, Gy.Up, Ou, Bu), QC = R(n0, Gy.Down, Bu, Ou), ZC = Gn, e1 = Gs, t1 = function (e, t) {
            var n = e.selection.getRng(), r = e.getBody();
            if (t) {
                var o = cs.fromRangeEnd(n), i = Zy(r, o);
                return Z(i.positions)
            }
            return o = cs.fromRangeStart(n), Q((i = Qy(r, o)).positions)
        }, n1 = R(x0, !0), r1 = R(x0, !1), o1 = function (e) {
            ...
            return e.y > t
        }), s1 = R(iC, Qy), c1 = R(iC, Zy), l1 = function (e, t) {
            return n = cs.after(t), !!Kn(n.getNode()) || tf(e, cs.after(t)).map(function (e) {
                return Kn(e.getNode())
            }).getOr(!1);
            var n
        }, f1 = ir([{br: []}, {block: []}, {none: []}]), d1 = dt().browser, m1 = dt(), g1 = R(KC, wo), p1 = R(KC, " "),
    ...
    function x1(e, S) {
        ...
        return S.on("remove", N.stop), function (w) {
    ...
    function w1(e) {
        ...
        var r, o, i, s, u, c, a = du(), l = eu.DOM, f = document, d = x1(u = a, c = e), m = (r = i = a, function () {
            r.on(function (e) {
    ...
    function E1(l) {
        ...
        function p(e, t) {
            ...
            if (e.collapsed) {
                if (!g(e)) {
                    var n = t ? 1 : -1, r = oc(n, x, e), o = r.getNode(!t);
            ...
            if (s === u + 1 && a === e.endContainer) {
                ...
                if (f(c)) return function (e) {
                    ...
                    var r = function (e, t, n) {
                        var r = l.$, o = br(Et.fromDom(l.getBody()), "#" + w).fold(function () {
                            return r([])
                        }, function (e) {
                            return r([e.dom])
                        });
                        ...
                        var i = y.createRng();
                        t === n && xt.ie ? (o.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(t), i.setStartAfter(o[0].firstChild.firstChild), i.setEndAfter(t)) : (o.empty().append(wo).append(t).append(wo), i.setStart(o[0].firstChild, 1), i.setEnd(o[0].lastChild, 0)), o.css({top: y.getPos(e, l.getBody()).y}), o[0].focus();
                        var a = b.getSel();
        ...
        var v, n, e, o, b = l.selection, y = l.dom, C = y.isBlock, x = l.getBody(), i = Ws(l, x, C, function () {
            return Cd(l)
        }), w = "sel-" + y.uniqueId(), S = "data-mce-selected", r = b.getRng, N = function () {
            i.hide()
        };
        return xt.ceFalse && !hh(l) && (l.on("mouseup", function (e) {
            ...
            }, hideFakeCaret: N, destroy: function () {
                i.destroy(), v = null
            }
        }
    }
    ...
    function k1(a) {
        ...
        var p = Nt.each, h = If.BACKSPACE, v = If.DELETE, b = a.dom, y = a.selection, C = a.parser, x = xt.gecko,
            w = xt.ie, S = xt.webkit, N = "data:text/mce-internal,", E = w ? "Text" : "URL", k = te;
    ...
    function D1(e) {
        ...
        e.bindPendingEventDelegates(), e.initialized = !0, e.fire("Init"), e.focus(!0), n = (u = e).dom.getRoot(), u.inline || Pl(u) && u.selection.getStart(!0) !== n || rf(n).each(function (e) {
            var t, n, r, o, i = e.getNode(), a = cn(i) ? rf(i).getOr(e) : e;
        ...
        }), e.nodeChanged({initial: !0}), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && Ar.setEditorTimeout(t, function () {
    ...
    function O1(e) {
        ...
        var r, o = T1(e), i = Bs(e), a = e.contentCSS;
    ...
    function B1(e) {
        ...
        !0 !== e.removed && (hh(t = e) || t.load({
            initial: !0,
            format: "html"
        }), t.startContent = t.getContent({format: "raw"}), D1(e))
    }
    ...
    function P1(t, e) {
        ...
        k = _, (E = t).addCommand("delete", function () {
            ...
            !function (e) {
                ...
                return !1
            }(x, n, w), "" !== x.getAttrib(n, Dy) === r && !t || (x.setAttrib(n, Dy, r ? S : null), x.setAttrib(n, "aria-placeholder", r ? S : null), C.fire("PlaceholderToggle", {state: r}), C.on(r ? "keydown" : "keyup", N), C.off(r ? "keyup" : "keydown", N)))
    ...
    function L1(e, t) {
        ...
        return e.contentAreaContainer = t.iframeContainer, e.iframeElement = u, e.iframeHTML = function (e) {
            ...
            var n = Ns(e, "body_id", "tinymce"), r = Ns(e, "body_class", ""),
    ...
    function U1(e) {
        ...
        var c = F1(e), l = e, f = ve.from(c.api).getOr({}), d = {
    ...
    function j1(c, l) {
        var e, t, f = ou.ScriptLoader, n = f, r = l, o = function () {
    ...
    var K1 = Gn, X1 = Yn, Y1 = function (e) {
            e.on(function (e) {
                C1(e.ghost)
            }), e.clear()
        }, G1 = Yn, J1 = Gn, Q1 = eu.DOM, Z1 = eu.DOM, ex = eu.DOM, tx = function (t, n, r) {
            var o, i, a, u, e = Xv.get(r), s = Xv.urls[r] || t.documentBaseUrl.replace(/\/$/, "");
        ...
        }, nx = eu.DOM, rx = {"font-size": "size", "font-family": "face"}, ox = V1("font-size"), ix = i(function (e) {
            return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
        }, V1("font-family")), ax = Nt.each, ux = Nt.map, sx = Nt.inArray,
            ...
            this.addCommands({
                ...
                return $1(t = u, function (n) {
                    ...
                    return Tg(n, function (e) {
                        ...
                        var e = parseFloat(wn(n, "line-height")), t = parseFloat(wn(n, "font-size"));
                        return String(e / t)
                    })
                }).getOr("");
                var t
    ...
    var vx = "data-mce-contenteditable",
        ...
        yx = (Cx.isNative = function (e) {
            ...
            var n = e.toLowerCase(), r = so(n, t || {}, this.scope);
    ...
    var _x, Ax = {
    ...
    }), Tx = ["design", "readonly"], Ox = Nt.each, Bx = Nt.explode, Px = {
        f1: 112,
        f2: 113,
        f3: 114,
        f4: 115,
        ...
        f11: 122,
        f12: 123
    }, Lx = Nt.makeMap("alt,ctrl,shift,meta,access"), Ix = (Mx.prototype.add = function (e, n, t, r) {
    ...
    var Fx = eu.DOM, Ux = Nt.extend, zx = Nt.each, Hx = Nt.resolve, jx = xt.ie,
        Vx = (qx.prototype.render = function () {
            ...
            if (t) {
                (e = e || {}).load = !0;
                var n = jn(t) ? t.value : t.innerHTML, r = this.setContent(n, e);
    ...
    function qx(e, t, n) {
        ...
        this.mode = A, this.setMode = A.set, n.fire("SetupEditor", {editor: this}), this.execCallback("setup", this), this.$ = Ya.overrideDefaults(function () {
    ...
    function Kx(t) {
        var e = nw;
        delete tw[t.id];
        for (var n = 0; n < tw.length; n++) if (tw[n] === t) {
            tw.splice(n, 1);
            break
        }
    ...
    var Xx, Yx = eu.DOM, Gx = Nt.explode, Jx = Nt.each, Qx = Nt.extend, Zx = 0, ew = !1, tw = [], nw = [],
        rw = "CSS1Compat" !== document.compatMode, ow = _e(_e({}, Ax), {
            baseURI: null,
            baseURL: null,
            defaultSettings: {},
            ...
            settings: {},
            setup: function () {
                var e, t = "", n = nv.getDocumentBaseUrl(document.location);
            ...
            add: function (e) {
                var n = this;
                return tw[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (tw[e.id] = e), tw.push(e), nw.push(e)), Wx(!0), n.activeEditor = e, n.fire("AddEditor", {editor: e}), Xx || (Xx = function (e) {
    ...
    var sw, cw, lw, fw, dw = Math.min, mw = Math.max, gw = Math.round, pw = {
        inflate: function (e, t, n) {
            return uw(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n)
        }, relativePosition: iw, findBestRelativePosition: function (e, t, n, r) {
            for (var o, i = 0; i < r.length; i++) if ((o = iw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
            return null
        }, intersect: function (e, t) {
            var n = mw(e.x, t.x), r = mw(e.y, t.y), o = dw(e.x + e.w, t.x + t.w), i = dw(e.y + e.h, t.y + t.h);
            return o - n < 0 || i - r < 0 ? null : uw(n, r, o - n, i - r)
        }, clamp: function (e, t, n) {
            var r = e.x, o = e.y, i = e.x + e.w, a = e.y + e.h, u = t.x + t.w, s = t.y + t.h, c = mw(0, t.x - r),
                l = mw(0, t.y - o), f = mw(0, i - u), d = mw(0, a - s);
            return r += c, o += l, n && (i += c, a += l, r -= f, o -= d), uw(r, o, (i -= f) - r, (a -= d) - o)
        }, create: uw, fromClientRect: function (e) {
    ...
    var yw, Cw, xw, ww = Math.min, Sw = Math.max, Nw = Math.round, Ew = {
        serialize: function (e) {
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = eu.DOM, o = (void 0 !== t.count ? t : n).count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", _w.fire("beforeInitialize", {settings: e}), (t = new XMLHttpRequest).overrideMimeType && t.overrideMimeType(e.content_type), t.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async), e.crossDomain && (t.withCredentials = !0), e.content_type && t.setRequestHeader("Content-Type", e.content_type), e.requestheaders && Nt.each(e.requestheaders, function (e) {
    ...
    }), Aw = Nt.extend, Rw = (Dw.sendRPC = function (e) {
        return (new Dw).send(e)
    }, Dw.prototype.send = function (e) {
        var n = e.error, r = e.success, o = Aw(this.settings, e);
    ...
    var Bw = {
        ...
        isGecko: xt.gecko,
        isMac: xt.mac
    }, Pw = Nt.extend(ow, Bw), Lw = Pw;
    window.tinymce = Lw, window.tinyMCE = Lw, function (e) {
